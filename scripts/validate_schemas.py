...
JSON_INSTANCE_SCHEMAS={"examples/domain-pack/.yaaw/domain-pack.json":"domain-pack.schema.json","examples/domain-pack/.yaaw/domain-pack.lock.json":"domain-pack-lock.schema.json","examples/domain-pack/.yaaw/repository-map.json":"repository-map.schema.json","config/model-profiles.example.json":"model-profiles.schema.json","config/operating-modes.json":"operating-modes.schema.json","config/runtime-adapters.json":"runtime-adapters.schema.json","config/external-adapters.example.json":"external-adapters.schema.json","examples/integrations/external-observation.json":"external-observation.schema.json","examples/integrations/change-set.json":"change-set.schema.json","evals/agent-loop-fixture.json":"agent-eval.schema.json"}
