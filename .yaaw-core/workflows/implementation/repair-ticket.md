...
4. If repair requires product/architecture contract changes, return `REPLAN_REQUIRED` and stop.
5. Rerun relevant verification and append the next `.yaaw/evidence/<SPEC-ID>/<TASK-ID>-V<VERSION>.json`.
