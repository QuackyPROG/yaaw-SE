...
## Inputs
Current product/engineering state, repository evidence/capability, research metadata, and `.yaaw-core/rules/assumption-challenge.md` plus `.yaaw-core/rules/research-admission.md`.
