...
Use this module when a ticket, design, or review has non-trivial maintainability implications. The canonical mandatory policy is `.yaaw-core/system/rules/changeability.md`; this module provides deeper reasoning and examples, not additional authority.
