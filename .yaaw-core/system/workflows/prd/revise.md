...
## Inputs
Current accepted product revision, explicit human-requested change, and `.yaaw-core/system/rules/assumption-challenge.md`.
...
5. Execute `.yaaw-core/system/core/invalidation.md` against dependent engineering decisions, specs, tickets, and reviews.
