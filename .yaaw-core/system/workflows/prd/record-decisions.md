...
## Inputs
Current product artifact, latest human answers, and `.yaaw-core/system/rules/assumption-challenge.md`.
...
6. If downstream planning/spec/ticket artifacts already depend on changed intent, execute the invalidation policy in `.yaaw-core/system/core/invalidation.md`.
