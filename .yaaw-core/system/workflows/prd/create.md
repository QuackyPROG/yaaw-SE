...
## Inputs
Human's product goal, product template, current state, and `.yaaw-core/system/rules/assumption-challenge.md`.

## Procedure
1. If the canonical YAAW layout is incomplete, create missing `.yaaw-core/project/`, `.yaaw-core/runtime/`, and required durable artifacts from `.yaaw-core/system/templates/`; never overwrite existing project memory.
