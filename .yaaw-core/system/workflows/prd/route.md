...
## Inputs
`.yaaw-core/project/product.md` if present, `.yaaw-core/project/state.json`, current request, and relevant accepted product history.
...
2. For a workflow route, resolve the canonical ID through `.yaaw-core/system/registries/workflows.json` and execute it; do not stop after classification.
