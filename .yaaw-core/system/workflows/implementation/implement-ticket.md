...
2. Load the ticket, referenced product/spec/decisions/research, `.yaaw-core/system/rules/changeability.md`, relevant .yaaw-core/system/rules/expertise, and relevant code only.
