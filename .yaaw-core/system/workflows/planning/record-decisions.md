...
## Inputs
Current engineering artifact, latest accepted engineering answers, current product authority, repository evidence, resolved research referenced by the frontier, and `.yaaw-core/system/rules/assumption-challenge.md`.
