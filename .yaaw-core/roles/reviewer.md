...
- Optional learned project memory only according to the handoff `context_policy`, and only after primary evidence review.
...
- Only after the primary review may memory be used as a lead for recurring regressions, previous review findings, historical problem patterns, subsystem conventions, known failure modes, or ambiguous rationale. Verify anything material against current authority/reality.
